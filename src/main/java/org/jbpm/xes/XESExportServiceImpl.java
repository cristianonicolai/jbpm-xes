...
//      TODO: Include variables from tasks and processes
        ...
        LOGGER.debug("Found {} process instances to export.",
                     tracesDataSet.getRowCount());

        if (tracesDataSet.getRowCount() == 0) {
            LOGGER.warn("Could not find any process instance to export, please review filter: {}",
                        filter);
            return null;
        }
        ...
        LOGGER.info("XES exported finished in {} seconds",
